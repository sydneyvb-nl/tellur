...
| Codex CLI/App | Personal-plugin hooks, JSONL import | `tellur setup agents` generates and enables one local Codex plugin for both lifecycle capture and manual workflows; obsolete duplicate user-level Tellur hooks are removed. |
