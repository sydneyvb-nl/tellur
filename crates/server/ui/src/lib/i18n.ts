...
const en: Record<string, string> = {
  ...
  "overview.eyebrow": "Engineering governance",
  "overview.lede": "AI involvement, review coverage, and evidence across your codebase.",
  "overview.updated": "Updated {time}",
  "overview.loadFailed": "The organization overview could not be loaded.",
  "overview.attention": "Needs attention",
  "overview.reviewGapHeadline": "{n} AI-attributed lines still need review",
  "overview.clearHeadline": "All AI-attributed lines are reviewed",
  "overview.noAiHeadline": "No AI-attributed lines recorded yet",
  "overview.noAiContext": "Activity exists, but line attribution has not identified AI-generated code yet.",
  "overview.reviewGapContext": "Across {repos} repositories · {coverage} review coverage",
  "overview.reviewRepos": "Review repositories",
  "overview.keyMetrics": "Governance metrics",
  "overview.kpiGap": "AI lines awaiting review",
  "overview.priority": "Priority queue",
  "overview.allRepos": "All repositories",
  "overview.aiShareSuffix": "AI share",
  "overview.evidence": "Evidence volume",
  "overview.activityTitle": "30-day provenance activity",
...
const nl: Record<string, string> = {
  ...
  "overview.eyebrow": "Engineering governance",
  "overview.lede": "AI-betrokkenheid, reviewdekking en bewijs voor je codebase.",
  "overview.updated": "Bijgewerkt {time}",
  "overview.loadFailed": "Het organisatieoverzicht kon niet worden geladen.",
  "overview.attention": "Vereist aandacht",
  "overview.reviewGapHeadline": "{n} AI-toegeschreven regels wachten op review",
  "overview.clearHeadline": "Alle AI-toegeschreven regels zijn gereviewd",
  "overview.noAiHeadline": "Nog geen AI-toegeschreven regels vastgelegd",
  "overview.noAiContext": "Er is activiteit, maar de regelattributie heeft nog geen AI-gegenereerde code gevonden.",
  "overview.reviewGapContext": "Over {repos} repository's · {coverage} reviewdekking",
  "overview.reviewRepos": "Repository's reviewen",
  "overview.keyMetrics": "Governance-metrics",
  "overview.kpiGap": "AI-regels zonder review",
  "overview.priority": "Prioriteitenlijst",
  "overview.allRepos": "Alle repository's",
  "overview.aiShareSuffix": "AI-aandeel",
  "overview.evidence": "Bewijsvolume",
  "overview.activityTitle": "Provenance-activiteit over 30 dagen",
