...
const en: Record<string, string> = {
  ...
  "fileView.note": "Provenance metadata only — the hub never stores or proxies source text.",
...
const nl: Record<string, string> = {
  ...
  "fileView.note": "Alleen provenance-metadata — de hub bewaart of proxyt nooit broncode.",
